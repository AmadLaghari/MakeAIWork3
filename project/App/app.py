...
model = joblib.load("project/Model/Medische_data_model_Manual_scikitlearn2b.pkl")
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        my_image = customtkinter.CTkImage(light_image=Image.open("project/App/wassching.png"),
            dark_image=Image.open("project/App/wassching.png"),
            size=(50,50),
            )
